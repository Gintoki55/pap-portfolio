...
type ProjectType = 'front-end' | 'Full-Stack MERN' | 'back-end' | string;
...
const ProjectsJsx = () => {
  ...
  const typeIcons:Record<ProjectType, React.JSX.Element>= {
              ...
              <div className="flex flex-col justify-between flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.icons.map((icon, i) => {
                    const iconName = icon.split("/").pop()?.split(".")[0] ?? "unknown";
